...
MATRIX = [
    ...
    {
        "keywords": ["underground services", "underground utilities", "buried services",
                     "service detection", "pothole", "pot hole", "service locating",
                     "cable detection", "pipe detection", "locating services"],
        "hrcw": False,
        "hrcw_category": None,
        "hrcw_license_class": None,
        "ppe": [
            "Insulated gloves — where electrical services possible",
            "Safety glasses",
            "Hard hat",
        ],
        "certs": [
            "Dial Before You Dig (1100) — mandatory before every ground penetration",
            "Service locating — accredited locator engaged before mechanical excavation",
        ],
        "permits": [
            "Potholing — hand excavation or vacuum excavation to confirm service location",
        ],
        "qualifications": [
            "Accredited service locator — on site before mechanical excavation",
            "No mechanical excavation — within 300mm of confirmed service location",
        ],
        "notifications": [
            "Dial Before You Dig — minimum 2 business days before ground penetration",
            "Utility owner — direct notification where services within dig zone",
        ],
        "safework_notification": False,
        "epa_license": False,
        "notes": [
            "Dial Before You Dig — free service, 1100 or www.1100.com.au",
            "Potholing — vacuum excavation preferred for service confirmation",
            "Hand dig zone — mandatory 300mm each side of confirmed service",
        ],
    },
