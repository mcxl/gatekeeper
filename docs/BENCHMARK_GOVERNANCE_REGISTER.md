...
| Lingate remedial works benchmark | SWMS | Internal product owner | ACTIVE | Prompt-level: demolition/removal task not generated before waterproofing. CCVS improved. | Prompt enrichment for demolition/removal task generation in remedial waterproofing sequences | Two LBV cycles complete (2026-03-29). CCVS keywords expanded (waterproof→CHM, slab crack→SIL). Demolition task gap identified as prompt-level. |
