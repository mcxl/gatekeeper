...
| EWP roof access benchmark | SWMS | Internal product owner | ACTIVE_WITH_KNOWN_DEFECTS | (1) WAH threshold no longer applies EWP-specific 90% override on regen — investigate trigger condition (2) Task 1.1 mobilise/position missing CCVS monitoring code (3) Repeated SYS-M3 invalid-CCVS warnings during generation (4) HRCW undercall — agent not tagging powered_mobile_plant for EWP scope | Investigate root cause of EWP threshold path before slicing further fixes | Regression check 2026-05-03 against current pipeline (brief `job_briefs/c12_ewp_roof_access.json`): 25/29 pass, 2 FAIL, 2 REVIEW. Last cycle (2026-03-29) was 8/9 pass with 90% EWP threshold; gate has grown from 9 to 29 checks since. Stream parked — not closeable. Cost per regen ~$0.022 Haiku. |
| Lingate remedial works benchmark | SWMS | Internal product owner | AWAITING_EXTERNAL_REVIEW | V9b rendered and submitted. Validator PASS_INTERNAL (0 fails, 0 reviews). Issue gate on docx: 0 FAIL, 1 REVIEW (placeholder). Internal reviewer: BELOW_WORKING_DRAFT (2 generation-variance hard fails, 44 review items). All deterministic fixes exhausted. Task sequence correct. | Third external Aussie WHS submission. Awaiting verdict. | Close when external review returns STRONG_WORKING_DRAFT or above. Updated 2026-03-31. |
