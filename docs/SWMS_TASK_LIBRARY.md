...
```python
{
    ...
    "controls": (
        ...
        "PPE: Harness clipped to manufacturer anchor, helmet, hi-vis, safety boots.\n"
...
```python
{
    ...
    "controls": (
        ...
        "PPE: Helmet, safety boots, harness during erection/dismantling.\n"
...
```python
{
    ...
    "controls": (
        ...
        "PPE: Rope access harness, helmet with chin strap, gloves, eye protection.\n"
...
```python
{
    ...
    "controls": (
        ...
        "PPE: Rope access harness, helmet, gloves, task-specific PPE.\n"
...
```python
{
    ...
    "controls": (
        ...
        "PPE: Insulated gloves, safety glasses, ELE-rated footwear."
    ),
    "post": 1,
...
```python
{
    ...
    "controls": (
        ...
        "PPE: Hi-vis, helmet, safety boots."
    ),
    "post": 2,
    "resp": "Supervisor",
    "audit": "STD-9-3-ELE",
...
```python
{
    ...
    "controls": (
        ...
        "PPE: P2/P3 respirator, safety glasses, hearing protection, gloves.\n"
        "Remove from exposure and rectify if dust controls fail."
    ),
    "post": 2,
    "resp": "Supervisor",
...
```python
{
    ...
    "controls": (
        ...
        "PPE: P2/P3 respirator, eye protection, gloves, hearing protection.\n"
        "Remove from exposure and rectify if dust controls fail."
    ),
    "post": 2,
    "resp": "Supervisor",
...
```python
{
    ...
    "controls": (
        ...
        "PPE: P2/P3 respirator, face shield, hearing protection, gloves, safety boots.\n"
...
```python
{
    ...
    "controls": (
        ...
        "PPE: Helmet, safety boots, P2/P3 RPE, eye and face protection."
    ),
    "post": 2,
    "resp": "Supervisor",
    "audit": "STD-6-3-STR",
...
```python
{
    ...
    "controls": (
        ...
        "PPE: Helmet, hi-vis, safety boots, gloves."
    ),
    "post": 2,
...
```python
{
    ...
    "controls": (
        ...
        "fire-resistant clothing, safety boots."
    ),
    "post": 2,
    "resp": "Supervisor",
    "audit": "STD-6-3-HOT",
...
```python
{
    ...
    "controls": (
        ...
        "PPE: Helmet, hi-vis, safety boots — all persons on site."
    ),
    "post": 2,
    "resp": "Supervisor / Operator",
    "audit": "STD-6-3-MOB",
...
```python
{
    ...
    "controls": (
        ...
        "PPE: Helmet, hi-vis, safety boots — all persons in forklift operating area."
    ),
    "post": 2,
...
```python
{
    ...
    "controls": (
        ...
        "PPE: P2 minimum, disposable coveralls, gloves, eye protection. "
...
cannot be maintained — STOP and implement approved TPMP. Hi-vis mandatory
...
```python
{
    ...
    "controls": (
        ...
        "PPE: Chemical-resistant gloves, eye protection, appropriate respiratory protection."
    ),
    "post": 1,
    "resp": "Supervisor",
    "audit": "STD-4-2-ENV",
...
```python
{
    ...
    "controls": (
        ...
        "Eye protection and gloves during scraping and chemical application. "
...
```python
{
    ...
    "controls": (
        ...
        "PPE: Waterproof footwear, face shield, gloves, hearing protection.\n"
