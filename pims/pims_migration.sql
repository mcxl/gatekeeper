...
-- ============================================================
-- pims_precedent_examples: historical/approved precedent corpus
-- (migration 005). Used as adaptation references for the live
-- enrichment path. NOT a write target for live observations.
-- ============================================================
