...
async def generate_narrative_summary(
    ...
    system = (
        ...
        "passive voice without a named actor. Do not invent counts, "
        "names, dates, or breaches not in the input. Return ONLY "
        "the paragraph text — no JSON, no quotes, no markdown."
    )
    user_text = (
