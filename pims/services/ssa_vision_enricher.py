...
_SYSTEM_PROMPT = (
    ...
    '  required_action      SHORT one-clause sentence, max 12 words, '
    'starting with "<Urgency> – " where Urgency is one of '
    'Immediate / Within 7 days / Next audit / Ongoing. Examples: '
    '"Immediate – exclusion zones to be maintained at all times", '
    '"Within 7 days – mount extinguishers on compliant brackets". '
    'Do NOT name specific personnel, hold points, or activity refs '
    'in this field — those belong in the finding text. Keep it to '
    ...
    "  * No em-dash clusters.\n"
    "  * No rule-of-three lists (\"fast, cheap, and reliable\").\n"
